 ...
 * across all tx-submitting MCP tools. Replaces the separate in-memory trackers
 ...
 *   with CLI skills (aibtcdev/skills#240)
 *
 ...
 * next nonce, or 0 if no state exists for the address (caller should then
